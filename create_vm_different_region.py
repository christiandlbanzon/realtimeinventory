#!/usr/bin/env python3
"""Create VM in a completely different region to avoid us-central1 issues"""
...
# Try completely different regions to avoid us-central1 issues
ZONES_TO_TRY = [
    "us-east1-b",      # East coast - different region entirely
    "us-west1-a",      # West coast - different region
...
print("="*80)
print("CREATING VM IN DIFFERENT REGION")
print("="*80)
print("\nIncident shows VM creation failures in us-central1-c (now resolved)")
print("But we're still getting 503s - trying different regions...\n")
...
if not success:
    print("\n" + "="*80)
    print("ALL REGIONS FAILED")
    print("="*80)
    print("\nEven different regions are returning 503 errors.")
    print("This suggests a broader Google Cloud API issue.")
    print("\nRecommendations:")
    print("1. Wait 30-60 minutes - resolution may take time to propagate")
    print("2. Try creating manually via Console")
    print("3. Check status page for new incidents")
    sys.exit(1)
